// Name: Ong Guo Xiang, Vincernt
// Full Time
// Tutorial Group: T07F
// File Name: Vincent_A3.java
...
class Vincent_A3{
    ...
    private static double sizes[] = new double[Diving.SIZE]; 	
    // Initialize an array of size 
    
    private static double carryforward[] = new double[Countries.length];
    // Initialise an array of carried forward scores
    
    private static ArrayList<Country> cList = new ArrayList<Country>();
    // Construct an arraylist of country object
    
    private static ArrayList<Diving> dList = new ArrayList<Diving>();
    // Initialise an arraylist of Diving object
    
    private static double difficulty[] = new double[Countries.length];
    // Initilize an array of difficulty
    
    private static ArrayList<Diving> temp = new ArrayList<Diving>();
    // Temporary arraylist used for sorting to view result table 
    
     public static void main(String[] args)
    {
    
    	for(int i = 0; i < carryforward.length; i++) 	//carryforward array to be 0.00 
        {
    		carryforward[i] = 0.00;
    	}
    	
        for (int i = 0; i < Countries.length; i++)   // Add countries to the cList arraylist
        { 
            cList.add(new Country(Countries[i], "Name " + (i + 1), getAge()));
        }
        
        for(int Rounds = 1; Rounds <= 5; Rounds++)  // Loop 5 times
        {
          
            for (int i = 0; i < Countries.length; i++)   // Add into difficulty array 
            {
    ...
    private static void displayResultInfo(ArrayList<Diving> aList) //Display result of judge 1 - 7 for each country
    {
     ...
     private static void displaySortedList(ArrayList<Diving> aList)   // Sorts the temp arraylist based on total score
     {
